...
public class Nivel1 extends World
{
    ...
    public void construyeNivel1()
    {
        ...
        vidas=new Letrero(30,"vidas:");
        rocket=new Letrero(10,"Rocket:");
        balas=new Letrero(1000,"Balas:");
        tiempo= new Letrero(0,"Tiempo:");
        
        addObject(tiempo,110,205);
   ...
   /**
    ...
    {
        int u=0,v=0,w=0,x,y,z,a=0,b=0,c=0,d=0,e=0,ye=0,t=0; 
        bMusic = 1;
