...
public class Heroe extends Actor
{
    ...
    public void setShot()
    {
        ...
        {
            try{
            mundo2=(Nivel2)getWorld();}catch(ClassCastException e){}
    ...
    public void verificaAlcanzado()
    {
        ...
        {
            mundo3 = (Nivel3)getWorld(); 
            if(this.isTouching(BalaJefe.class))//if(this.isTouching(Enemigo.class))
            {
                try{
            ...
            if(this.isTouching(balaFlota2.class))
            {
                try{
    ...
    public void contadordeVidas()
    {
        ...
        if(nivel==2)
        {
            try{
            Nivel2 mundo2=(Nivel2)getWorld();}catch(ClassCastException e){}
            try{if(mundo2.vidasN2.obtenerValor()<=0)
            {
                JuegoPerdido t=new JuegoPerdido();
                getWorld().addObject(t,((getWorld().getWidth()/2)+30),((getWorld().getHeight()/2)+150));
            }
