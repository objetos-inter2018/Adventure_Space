...
public class Flota2 extends Enemigo
{
    ...
    public void setShot()
    {
        ...
        if(isFlota && (x==8))//<>
        {
            //BalaFlota bf1 = new BalaFlota(1,1,8,'f',0,1);//0 abajo//0-2
           // BalaFlota bf2 = new BalaFlota(1,1,8,'f',0,1);//0 abajo
            balaFlota2 bf3 = new balaFlota2(1,1,8,'f',0,1);//0 abajo
